...
const Tile = (props: props) => {
    ...
    return (
        <a href={`/galeria/${props.folder}`} style={{backgroundImage: `url(${props.src})`}} className='h-[300px]  rounded-2xl bg-cover bg-center cursor-pointer transport-all duration-500 lg:hover:scale-110 lg:hover:transport-all lg:hover:duration-500 group lg:h-[450px]'>
