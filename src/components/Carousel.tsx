    ...
    return (
        <div className="w-full h-[550px] sm:h-[95vh] bg-gray-800 font-inria rounded-b-lg" id="Domov" >
            ...
            <div className="absolute flex items-center justify-between w-full top-[0%]">
                <div className="w-10 h-[550px] sm:h-[95vh] md:w-16 lg:w-24 flex lg:bg-gradient-to-r lg:from-black lg:to-white/0 lg:hover:to-white/10 justify-center items-center cursor-pointer outline-none">
                    <img className="w-16 h-16 lg:hover:animate-pulse" src="/chevron-compact-left.svg" alt="left-chevron" onClick={prevSlide} />
                </div>
                <Main />
                <div className="w-10 h-[550px] sm:h-[95vh] md:w-16 lg:w-24 flex lg:bg-gradient-to-r lg:from-white/0 lg:to-black lg:hover:bg-gradient-to-r lg:hover:from-white/10 lg:hover:to-black justify-center items-center right-0 cursor-pointer outline-none">
